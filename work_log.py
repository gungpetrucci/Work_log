...
def main_menu():
    ...
    while valid_answer == False:
        answer = input('Please choose [A]dd entry, [S]earch entry, [Q]uit: ').lower()
        if answer == 'a':
            valid_answer = True
            add_entry()
        elif answer == 's':
...
def search_menu():    
    ...
    while valid_answer == False:
        clear()
        print('--- SEARCH MENU ---')
        answer = input('Search by [T]ext, [P]attern, [M]inute spent, [D]ate of entry or [Q]uit to main menu: ').lower()
        if answer == 't':
            search_text()
        elif answer == 'm':
            search_minute()
...
def display_entry(navigate_list):
    ...
    while navigate == True:
        ...
        answer = input('\n\nView [N]ext entry, [P]revious entry or [B]ack to search menu: ').lower()
